# go-ruby-ransack documentation

**Pure-Go Ransack: search/filter query builder, CGO=0 — bound into rbgo**

`go-ruby-ransack/ransack` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `ransack`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `ransack`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`ransack`](https://github.com/go-ruby-ransack/ransack) | the library — Ruby's `ransack` in pure Go |
| [`docs`](https://github.com/go-ruby-ransack/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-ransack.github.io`](https://github.com/go-ruby-ransack/go-ruby-ransack.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-ransack/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-ransack/ransack](https://github.com/go-ruby-ransack/ransack).
