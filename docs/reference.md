...
The public API lives at the module root (`github.com/go-ruby-ransack/ransack`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `ransack`, while the surface follows
...
```go
import "github.com/go-ruby-ransack/ransack"
```
...
- **[pkg.go.dev/github.com/go-ruby-ransack/ransack](https://pkg.go.dev/github.com/go-ruby-ransack/ransack)**

The module's [README](https://github.com/go-ruby-ransack/ransack#readme) carries worked
